...
2. Enter API Base URL (e.g. `http://127.0.0.1:8000` for local backend) and tenant slug (`^[a-z0-9-]{3,50}$`), then press **Connect**. On Android emulator, localhost/127.0.0.1 is auto-mapped to `10.0.2.2`.
